...
diff --git a/examine_and_fix_patch.sh b/examine_and_fix_patch.sh
new file mode 100755
index 0000000000000000000000000000000000000000..1e65b1122992bb0d41a2bae22739ba792f280e13
--- /dev/null
+++ b/examine_and_fix_patch.sh
@@ -0,0 +1,72 @@
+#!/usr/bin/env bash
+set -euo pipefail
+
